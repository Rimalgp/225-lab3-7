pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/rimalgp'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/Rimalgp/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('rimalgp-225')                                                         //<------your MiamiID
    }
